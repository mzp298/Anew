...
\graphfile*[30]{figures//ep_01_damage.png}[]
\graphfile*[30]{figures//ep_02_damage.png}[]
\end{Figure}
...
\begin{table}[]
	...
	\begin{tabular}{lrrrr}
		\hline
		\textbf{samples} & \multicolumn{1}{l}{\textbf{$n_0$}} & \multicolumn{1}{l}{\textbf{\begin{tabular}[c]{@{}l@{}}Points\\   to failure\end{tabular}}} & \multicolumn{1}{l}{\textbf{\begin{tabular}[c]{@{}l@{}}Estimated\\   points to failure\end{tabular}}} & \multicolumn{1}{l}{\textbf{error}} \\ \hline
...
\begin{Figure}[h!]{Stress and damage evolution of aluminum alloy(sample 3 and 4) at random loading.}[]
	\graphfile*[30]{figures//ep_03_stress.png}[]
	\graphfile*[30]{figures//ep_03_damage.png}[]
	\\
\graphfile*[30]{figures//ep_04_1_stress.png}[]
\graphfile*[30]{figures//ep_04_1_damage.png}[]
\\
\graphfile*[30]{figures//ep_04_2_stress.png}[]
\graphfile*[30]{figures//ep_04_2_damage.png}[]
	\label{ep0304}
\end{Figure}
